...
<div class="row">
    <div class="col-md-12">
        {!! Form::model($model, array('url' => url('vendor/products', $model->id), 'method' => 'PUT', 'class' => 'form-horizontal form-row-seperated','files' => true)) !!}
                                    ...
                                    <div class="col-md-10">
                                        <div class="row" data-selectsplitter-wrapper-selector="">
                                            <div class="col-xs-12 col-sm-4">
                                                ...
                                                <option value="{{ $row->id }}" <?php echo ($category->parentId==$row->id)?'selected':''; ?>>
...
<!--                                        <span class="required"> * </span>-->
                        ...
                        <div class="tab-pane" id="tab_images">
                            ...
                            <div id="tab_images_uploader_container" class="text-align-reverse margin-bottom-10">
                                ...
                                <a class="btn btn-danger" data-href="{{ url('vendor/product/deleteallimages').'/'.$session_id }}" data-target="#confirm-delete"   data-toggle="modal">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="">
                            ...
                            <tbody id="content">
                                ...
                                <tr>
                                    ...
                                    <td><a data-href="<?php echo url('vendor/product/size/delete/'.$row->id); ?>" data-target="#confirm-delete"  class="btn btn-danger btn-sm"  data-toggle="modal" title="Delete">
...
getCategory('<?php echo $category->parentId?>',1,'<?php echo $category->categoryId?>');

setTimeout(function(){ getCategory('<?php echo $category->categoryId?>',2,'<?php echo $model->category_id?>'); }, 1000)
