...
<li id="" class="disabled">
    ...
    <div class="form-group upload col-sm-3 p0" onclick="window.open('<?php echo url('vendor/product/addimage/'.$product_id); ?>', '_blank', 'toolbar=no,scrollbars=yes,top=100,left=400,width=800,height=600');">
        <div class="upload-preview col-sm-12" id="uploadPreview">
...
<script>
    function confirmDelete(id)
    {
        ...
        if (r == true) {
            ...
            $.ajax({
            type:'get',
            url:'<?php echo url('vendor/product/deleteimage'); ?>/'+id,
...
$("ul.reorder-photos-list").sortable({ 
        ...
        $.ajax({
            type:'post',
            url:'<?php echo url('vendor/product/insertorder'); ?>',
            data:{
