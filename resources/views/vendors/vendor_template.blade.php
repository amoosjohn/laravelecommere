...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('front/css/vendor-style.css') }}" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white vendor-dashboard">
         <div class="page-wrapper">


            <!-- Header -->
            @include('vendors/commons/header')
           <!-- BEGIN CONTAINER -->
            <div class="page-container">
            <!-- Sidebar -->
            
            @include('vendors/commons/sidebar')
            <!-- BEGIN CONTENT -->
            ...
            <!-- /.content-wrapper -->
            <!-- Footer -->
            @include('vendors/commons/footer')
        </div>     
        ...
        <script src="{{ asset('admins/assets/global/plugins/jquery-repeater/jquery.repeater.js') }}" type="text/javascript"></script>
        <script src="{{ asset('admins/assets/pages/scripts/ecommerce-products-edit.min.js') }}" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="{{ asset('admins/assets/pages/scripts/form-repeater.min.js') }}" type="text/javascript"></script>
