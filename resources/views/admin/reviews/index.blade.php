                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo url('admin/reviews/'.$row->id.'/edit'); ?>" class="btn btn-primary btn-sm" title="Change Status"><i class="fa fa-edit"></i>
                                </a>
                                {!! Form::open(array('url' => 'admin/reviews/' .$row->id,'class'=>'form-inline form-delete','id'=>'delete')) !!}
