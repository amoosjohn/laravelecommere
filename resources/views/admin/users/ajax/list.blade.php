...
<tr>
    ...
    <td style="width: 10%;">
    <!--<a href="<?php echo url('admin/user/'.$row->id); ?>" class="btn dark btn-sm" title="User details"><i class="fa fa-eye"></i>
        </a>-->    
    <a href="<?php echo url('admin/users/' . $row->id . '/edit'); ?>" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-edit"></i>
    </a>
    {!! Form::open(array('url' => 'admin/users/' .$row->id,'class'=>'form-inline form-delete','id'=>'delete')) !!}
