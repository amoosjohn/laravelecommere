    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-green bold uppercase"> Total Size : {{ $model->total() }}  </span>
            
            </div>
            <div class="btn-group pull-right">
                <a href="{{ url('admin/size/create') }}" class="btn sbold green"> Add New
                ...
                <table class="table table-hover" data-toggle="dataTable" data-form="deleteForm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo url('admin/size/'.$row->id.'/edit'); ?>" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i>
                                </a>
                               {!! Form::open(array('url' => 'admin/size/' .$row->id,'class'=>'form-inline form-delete','id'=>'delete')) !!}
