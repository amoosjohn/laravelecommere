    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-green bold uppercase"> Total Customers : {{ $model->total() }}  </span>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Are you sure to change status for this customer?</p>
                            </div>

                            <div class="modal-footer">
                                <a class="btn btn-info btn-status">Yes</a>
...
<script>
    ...
    {    
        $.ajax({
            type: 'GET',
            url: "<?php echo url('admin/customer/search'); ?>",
            dataType: 'html',
            data: search,
